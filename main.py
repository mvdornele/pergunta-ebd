...
pergunta = {
    ...
    "opcoes": ["Eles comerão do fruto da árvore da vida, que está no meio do paraíso de Deus.", "Eles NÃO comerão do fruto da árvore da vida, que está no meio do paraíso de Deus."]
}
